...
_lr_productions = [
  ...
  ('expression -> expression variable_declaration NEWLINE','expression',3,'p_expression','main.py',107),
  ('expression -> expression variable_value_change NEWLINE','expression',3,'p_expression','main.py',108),
  ('expression -> variable_declaration NEWLINE','expression',2,'p_expression','main.py',109),
  ('expression -> variable_value_change','expression',1,'p_expression','main.py',110),
  ('expression -> NEWLINE','expression',1,'p_expression','main.py',111),
  ('variable_value_change -> IDENTIFIER EQUAL calculate','variable_value_change',3,'p_variable_value_change','main.py',118),
  ('variable_declaration -> VAR IDENTIFIER EQUAL calculate','variable_declaration',4,'p_variable_declaration_2','main.py',130),
  ('variable_declaration -> VAR IDENTIFIER','variable_declaration',2,'p_variable_declaration_1','main.py',137),
  ('calculate -> calculate PLUS calculate','calculate',3,'p_add','main.py',144),
  ('calculate -> calculate MINUS calculate','calculate',3,'p_sub','main.py',148),
  ('calculate -> MINUS calculate','calculate',2,'p_calculate2uminus','main.py',152),
  ('calculate -> calculate MUL calculate','calculate',3,'p_mul_div','main.py',157),
  ('calculate -> calculate DIV calculate','calculate',3,'p_mul_div','main.py',158),
  ('calculate -> INT','calculate',1,'p_calculate2num','main.py',169),
  ('calculate -> IDENTIFIER','calculate',1,'p_calculate2str','main.py',175),
  ('calculate -> LSB calculate RSB','calculate',3,'p_parens','main.py',183),
]
