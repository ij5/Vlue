...
_lr_productions = [
  ...
  ('if_statement_2 -> if_statement_2 ELSE IF LSB condition RSB LMB expression RMB','if_statement_2',9,'p_if_statement_2_2','main.py',438),
  ('if_statement_3 -> ELSE LMB expression RMB','if_statement_3',4,'p_if_statement_3','main.py',445),
  ('condition -> condition LB calculate','condition',3,'p_condition','main.py',458),
  ('condition -> condition RB calculate','condition',3,'p_condition','main.py',459),
  ('condition -> condition LB EQUAL calculate','condition',4,'p_condition_2','main.py',465),
  ('condition -> condition RB EQUAL calculate','condition',4,'p_condition_2','main.py',466),
  ('condition -> condition EQUAL calculate','condition',3,'p_condition_3','main.py',472),
  ('condition -> calculate','condition',1,'p_condition_4','main.py',478),
  ('use -> USE IDENTIFIER','use',2,'p_use','main.py',488),
  ('variable_value_change -> IDENTIFIER EQUAL LIST','variable_value_change',3,'p_variable_value_change_list','main.py',505),
  ('variable_value_change -> IDENTIFIER EQUAL calculate','variable_value_change',3,'p_variable_value_change','main.py',511),
  ('variable_declaration -> VAR IDENTIFIER EQUAL LIST','variable_declaration',4,'p_variable_declaration_list','main.py',537),
  ('variable_declaration -> VAR IDENTIFIER EQUAL calculate','variable_declaration',4,'p_variable_declaration_2','main.py',543),
  ('variable_declaration -> VAR IDENTIFIER','variable_declaration',2,'p_variable_declaration_1','main.py',559),
  ('calculate -> calculate PLUS calculate','calculate',3,'p_add','main.py',588),
  ('calculate -> calculate MINUS calculate','calculate',3,'p_sub','main.py',624),
  ('calculate -> MINUS calculate','calculate',2,'p_calculate2uminus','main.py',628),
  ('calculate -> calculate MUL calculate','calculate',3,'p_mul_div','main.py',633),
  ('calculate -> calculate DIV calculate','calculate',3,'p_mul_div','main.py',634),
  ('calculate -> INT','calculate',1,'p_calculate2num','main.py',645),
  ('calculate -> FLOAT','calculate',1,'p_calculate2num','main.py',646),
  ('calculate -> STRING','calculate',1,'p_calculate2num','main.py',647),
  ('calculate -> IDENTIFIER','calculate',1,'p_calculate2str','main.py',653),
  ('calculate -> LSB calculate RSB','calculate',3,'p_parens','main.py',661),
  ('empty -> <empty>','empty',0,'p_empty','main.py',667),
]
