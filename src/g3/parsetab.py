...
_lr_productions = [
  ...
  ('expression -> calculate','expression',1,'p_expression','main.py',1181),
  ('expression -> string_calculate','expression',1,'p_expression','main.py',1182),
  ('expression -> compare_expression','expression',1,'p_expression','main.py',1183),
  ('expression -> function_call','expression',1,'p_expression','main.py',1184),
  ('variable_declaration -> VAR IDENTIFIER EQUAL expression','variable_declaration',4,'p_variable_declaration','main.py',1193),
  ('variable_value_change -> IDENTIFIER EQUAL expression','variable_value_change',3,'p_variable_value_change','main.py',1211),
  ('function_call -> IDENTIFIER LSB function_call_parameter RSB','function_call',4,'p_function_call','main.py',1220),
  ('function_call_parameter -> function_call_parameter COMMA calculate','function_call_parameter',3,'p_function_call_parameter','main.py',1226),
  ('function_call_parameter -> calculate','function_call_parameter',1,'p_function_call_parameter','main.py',1227),
  ('function_call_parameter -> empty','function_call_parameter',1,'p_function_call_parameter','main.py',1228),
  ('function_declaration -> FUNCTION IDENTIFIER LSB function_parameter RSB LMB root RMB','function_declaration',8,'p_function_declaration','main.py',1240),
  ('function_parameter -> function_parameter COMMA IDENTIFIER','function_parameter',3,'p_function_parameter','main.py',1261),
  ('function_parameter -> IDENTIFIER','function_parameter',1,'p_function_parameter','main.py',1262),
  ('function_parameter -> empty','function_parameter',1,'p_function_parameter','main.py',1263),
  ('while_statement -> WHILE LSB compare_expression RSB LMB root RMB','while_statement',7,'p_while_statement','main.py',1278),
  ('if_statement -> IF LSB compare_expression RSB LMB root RMB','if_statement',7,'p_if_statement','main.py',1285),
  ('if_statement -> if_statement ELSE IF LSB compare_expression RSB LMB root RMB','if_statement',9,'p_if_statement','main.py',1286),
  ('if_statement -> if_statement ELSE LMB root RMB','if_statement',5,'p_if_statement','main.py',1287),
  ('compare_expression -> compare_expression compare_operator calculate','compare_expression',3,'p_compare_expression','main.py',1296),
  ('compare_expression -> calculate','compare_expression',1,'p_compare_expression','main.py',1297),
  ('compare_operator -> LB','compare_operator',1,'p_compare_operator','main.py',1303),
  ('compare_operator -> RB','compare_operator',1,'p_compare_operator','main.py',1304),
  ('compare_operator -> LB EQUAL','compare_operator',2,'p_compare_operator','main.py',1305),
  ('compare_operator -> RB EQUAL','compare_operator',2,'p_compare_operator','main.py',1306),
  ('compare_operator -> EQUAL EQUAL','compare_operator',2,'p_compare_operator','main.py',1307),
  ('compare_operator -> NOTEQUAL EQUAL','compare_operator',2,'p_compare_operator','main.py',1308),
  ('string_calculate -> string_calculate stringoperator STRING','string_calculate',3,'p_string_calculate','main.py',1316),
  ('string_calculate -> STRING','string_calculate',1,'p_string_calculate','main.py',1317),
  ('stringoperator -> PLUS','stringoperator',1,'p_stringOperator','main.py',1323),
  ('calculate -> calculate baseoperator INT','calculate',3,'p_calculate','main.py',1329),
  ('calculate -> calculate baseoperator FLOAT','calculate',3,'p_calculate','main.py',1330),
  ('calculate -> calculate baseoperator IDENTIFIER','calculate',3,'p_calculate','main.py',1331),
  ('calculate -> INT','calculate',1,'p_calculate_type_int','main.py',1343),
  ('calculate -> FLOAT','calculate',1,'p_calculate_type_float','main.py',1347),
  ('calculate -> IDENTIFIER','calculate',1,'p_calculate_type_identifier','main.py',1352),
  ('baseoperator -> PLUS','baseoperator',1,'p_baseOperator','main.py',1358),
  ('baseoperator -> MINUS','baseoperator',1,'p_baseOperator','main.py',1359),
  ('baseoperator -> MUL','baseoperator',1,'p_baseOperator','main.py',1360),
  ('baseoperator -> DIV','baseoperator',1,'p_baseOperator','main.py',1361),
  ('empty -> <empty>','empty',0,'p_empty','main.py',1368),
]
