...
_lr_productions = [
  ...
  ('statement -> variable_declaration SEMI','statement',2,'p_statement','main.py',1156),
  ('statement -> variable_value_change SEMI','statement',2,'p_statement','main.py',1157),
  ('statement -> function_declaration','statement',1,'p_statement','main.py',1158),
  ('statement -> empty','statement',1,'p_statement','main.py',1159),
  ('statement -> expression SEMI','statement',2,'p_statement_expression','main.py',1164),
  ('expression -> calculate','expression',1,'p_expression','main.py',1171),
  ('expression -> string_calculate','expression',1,'p_expression','main.py',1172),
  ('expression -> compare_expression','expression',1,'p_expression','main.py',1173),
  ('expression -> function_call','expression',1,'p_expression','main.py',1174),
  ('variable_declaration -> VAR IDENTIFIER EQUAL expression','variable_declaration',4,'p_variable_declaration','main.py',1183),
  ('variable_value_change -> IDENTIFIER EQUAL expression','variable_value_change',3,'p_variable_value_change','main.py',1189),
  ('function_call -> IDENTIFIER LSB function_call_parameter RSB','function_call',4,'p_function_call','main.py',1196),
  ('function_call_parameter -> function_call_parameter COMMA calculate','function_call_parameter',3,'p_function_call_parameter','main.py',1201),
  ('function_call_parameter -> calculate','function_call_parameter',1,'p_function_call_parameter','main.py',1202),
  ('function_call_parameter -> empty','function_call_parameter',1,'p_function_call_parameter','main.py',1203),
  ('function_declaration -> FUNCTION IDENTIFIER LSB function_parameter RSB LMB root RMB','function_declaration',8,'p_function_declaration','main.py',1208),
  ...
  ('while_statement -> WHILE LSB compare_expression RSB LMB root RMB','while_statement',7,'p_while_statement','main.py',1222),
  ('if_statement -> IF LSB compare_expression RSB LMB root RMB','if_statement',7,'p_if_statement','main.py',1229),
  ('if_statement -> if_statement ELSE IF LSB compare_expression RSB LMB root RMB','if_statement',9,'p_if_statement','main.py',1230),
  ('if_statement -> if_statement ELSE LMB root RMB','if_statement',5,'p_if_statement','main.py',1231),
  ...
  ('calculate -> INT','calculate',1,'p_calculate_type_int','main.py',1281),
  ('calculate -> FLOAT','calculate',1,'p_calculate_type_float','main.py',1285),
  ('calculate -> IDENTIFIER','calculate',1,'p_calculate_type_identifier','main.py',1290),
  ('baseoperator -> PLUS','baseoperator',1,'p_baseOperator','main.py',1296),
  ('baseoperator -> MINUS','baseoperator',1,'p_baseOperator','main.py',1297),
  ('baseoperator -> MUL','baseoperator',1,'p_baseOperator','main.py',1298),
  ('baseoperator -> DIV','baseoperator',1,'p_baseOperator','main.py',1299),
  ('empty -> <empty>','empty',0,'p_empty','main.py',1306),
]
