...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement','main.py',1148),
  ('statement -> if_statement','statement',1,'p_statement','main.py',1149),
  ('statement -> while_statement','statement',1,'p_statement','main.py',1150),
  ('statement -> variable_declaration','statement',1,'p_statement','main.py',1151),
  ('statement -> variable_value_change','statement',1,'p_statement','main.py',1152),
  ('statement -> function_declaration','statement',1,'p_statement','main.py',1153),
  ('statement -> empty','statement',1,'p_statement','main.py',1154),
  ('expression -> calculate','expression',1,'p_expression','main.py',1162),
  ('expression -> compare_expression','expression',1,'p_expression','main.py',1163),
  ('variable_declaration -> VAR IDENTIFIER EQUAL expression SEMI','variable_declaration',5,'p_variable_declaration','main.py',1170),
  ...
  ('calculate -> calculate baseoperator INT','calculate',3,'p_calculate','main.py',1234),
  ('calculate -> calculate baseoperator FLOAT','calculate',3,'p_calculate','main.py',1235),
  ('calculate -> calculate baseoperator IDENTIFIER','calculate',3,'p_calculate','main.py',1236),
  ('calculate -> INT','calculate',1,'p_calculate','main.py',1237),
  ('calculate -> FLOAT','calculate',1,'p_calculate','main.py',1238),
  ('calculate -> IDENTIFIER','calculate',1,'p_calculate','main.py',1239),
  ('baseoperator -> PLUS','baseoperator',1,'p_baseOperator','main.py',1245),
  ('baseoperator -> MINUS','baseoperator',1,'p_baseOperator','main.py',1246),
  ('baseoperator -> MUL','baseoperator',1,'p_baseOperator','main.py',1247),
  ('baseoperator -> DIV','baseoperator',1,'p_baseOperator','main.py',1248),
  ('empty -> <empty>','empty',0,'p_empty','main.py',1255),
]
